        ...
        <section class=" md:pt-16 dark:bg-gray-900 antialiased">
            <div class="bg-gray-900 bg-opacity-20 mx-10 rounded-lg py-2 shadow-xl">
                <div class="max-w-screen-xl pb-10 gap-8 flex flex-col px-4 text-gray-700 mx-auto 2xl:px-0">
                    <div class="lg:grid lg:grid-cols-2 lg:gap-8">
                        <div class="shrink-0 items-start justify-center flex max-w-md lg:max-w-lg mx-auto">
                            @if (!empty($product->img))
                                <img src="{{ asset('uploads/' . $product->img) }}" style="border: 1rem"
                                    alt="{{ $product->name }}" class="max-w-sm p-1 rounded-lg h-auto">
                            @else
                        ...
                        <div class="mt-6 w-full sm:mt-8 lg:mt-0">
                            <div class="">
                                ...
                                <div id="description-container" x-data="{ isModalOpen: false }">
                                    ...
                                    <p id="description" class="mb-6 h-1/2 bg-slate-800 overflow-hidden line-clamp-3">
                                        {!! $product->description !!}
                                    </p>
                                    ...
                                    <div x-show="isModalOpen" x-cloak @click="isModalOpen = false"
                    ...
                    <div class="px-1 flex flex-col font-semibold text-xl gap-4 ">
                        <p class="pl-10 py-10">Pilihan Lain</p>
                        <div class="bg-gray-900 bg-opacity-25 py-5 rounded-lg ">
                                ...
                                @foreach ($products->take(6) as $product)
                                    <a href="/product/{{ $product->slug }}"
                                        ...
                                        <div class="relative flex py-2 justify-center">
                                            <h3 class="text-lg text-gray-900 font-medium text-center">
