    ...
    <div class="mx-auto px-4 py-6 sm:px-6 lg:px-8 mb-3 ">
        ...
        <div class="hidden md:block">
            <div class="pb-20 border-b-2">
                <div class=" px-10 flex gap-10 flex-col">

                    <div class="flex flex-row gap-20 ">
                        <div class="w-full h-full max-h-96 max-w-xs overflow-hidden rounded-lg">
                            <img src="https://jpbooks.co.id/files/upload/img-profile.jpg" class=" object-cover "
            ...
            <div class="flex flex-row py-8 border-b-2 px-10 justify-between">
                <div class="w-full max-w-2xl items-start  h-full">
