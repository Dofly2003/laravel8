...
<div  class="hidden mx-auto md:block max-w-7xl px-4 py-6 sm:px-6 text-white lg:px-8 mb-3">
    ...
    <div class="flex flex-row py-14  ">
        <div class="w-full max-w-2xl pl-10">
            <p class="w-14 my-4 py-1 px-3 rounded-md text-2xl">visi</p>
            <p class="w-14 my-4 py-1 px-3 rounded-md text-2xl">Misi</p>
            <div class="">
